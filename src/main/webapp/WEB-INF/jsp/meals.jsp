...
<section class="jumbotron pt-4" style="padding: auto;">
    ...
    <div id="filters">
        ...
        <button class="btn btn-primary" id="reset-filter-button" onclick="resetFilters()">
            <spring:message code="meal.resetFilters"/>
        </button>
    </div>
    <hr>
